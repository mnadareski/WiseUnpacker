...
namespace SabreTools.Serialization.Printers
{
    public class WiseOverlayHeader : IPrinter<OverlayHeader>
    {
        ...
        public static void Print(StringBuilder builder, OverlayHeader overlayHeader)
        {
            ...
            builder.AppendLine(overlayHeader.SomeData5DeflatedSize, "FILE000{n}.DAT deflated size");
            builder.AppendLine(overlayHeader.SomeData5InflatedSize, "FILE000{n}.DAT inflated size");
